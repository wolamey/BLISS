document.addEventListener("DOMContentLoaded", () => {
  ...
  function setMarginTop() {
    ...
    if (containerTop && about) {
      ...
      about.style.marginTop = `${containerTopHeight + 80}px`;
    }
  }
  ...
  function scaleContent() {
    ...
    if (screenWidth > 1200) {
      ...
      containerTop.style.transform = `scale(${1 / scale})`; // Компенсируем масштабирование для container_top
    } else {
      content.style.transform = "scale(1)"; // Отключаем масштабирование
      containerTop.style.transform = "scale(1)"; // Отключаем масштабирование
  ...
  const tokenomics_item_description = document.querySelectorAll(
    ".tokenomics_item_description"
  );
